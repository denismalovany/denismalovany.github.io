...
tags: ["Non-Profit UX", "Stakeholder Interviews", "Competitor Analysis", "Design System", "Client Workshops", "Sitemap Design"]
...
heroTitle: "Volunteer Centre County"
...
<div class="grid md:grid-cols-2 gap-10 items-start mb-16">
  <div>
    <img src="https://images.unsplash.com/photo-1559027615-cd4628902d4a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" alt="Volunteer Centre County" class="rounded-lg shadow-lg w-full h-auto object-cover" loading="lazy">
  </div>
  <div class="space-y-6">
    <div>
      <h3 class="text-sm font-semibold uppercase tracking-wide text-gray-500 mb-1">My Role</h3>
      <p class="text-gray-700">UX/UI Designer &amp; Product Designer/Manager &mdash; only designer on the project</p>
    </div>
    <div>
      <h3 class="text-sm font-semibold uppercase tracking-wide text-gray-500 mb-1">Team</h3>
      <p class="text-gray-700">Cross-functional: product design, project management, development, QA</p>
    </div>
  </div>
</div>
...
<div class="mb-12">
  ...
  <p class="text-gray-700 leading-relaxed">
    As a fixed-price contract with a tight deadline, every decision mattered. The challenge was to deliver a cohesive platform that served two distinct audiences &mdash; volunteers seeking opportunities and nonprofits managing their presence &mdash; without scope creep or costly rework.
  </p>
</div>
...
<div class="mb-12">
  ...
  <p class="text-gray-700 leading-relaxed mb-4">
    The client was very satisfied with the final platform. The deep involvement throughout the process meant there was zero need for post-delivery revision requests &mdash; she fully understood what had been built, why, and how it addressed her needs.
  </p>
  <p class="text-gray-700 leading-relaxed">
    Perhaps the strongest signal of success: the client already had a clear roadmap for future improvements, based directly on the mindmap and sitemap we created together at the project's outset. The platform wasn't just delivered &mdash; it was set up to grow.
  </p>
</div>
...
<div class="mb-12">
  ...
  <ul class="list-disc pl-6 space-y-3 text-gray-700 leading-relaxed">
    ...
    <li><strong>Scope discipline is a team sport.</strong> When the whole team understands the scope, everyone becomes a guardrail against creep.</li>
    <li><strong>Iterate on visual direction early.</strong> The first style tile was rejected &mdash; but catching it early meant minimal wasted effort and a stronger final direction.</li>
    <li><strong>Design for the next version too.</strong> The mindmap and sitemap doubled as a future roadmap, giving the client a clear path forward after launch.</li>
  </ul>
</div>
